...
public class InfSoulGem extends Item implements IDemonWillGem, IMeshProvider, IMultiWillTool {

    public InfSoulGem() {
        super();

        setRegistryName("InfSoulGem");
        setTranslationKey(BloodMagic.MODID + ".gctcore.InfSoulGem");
        setMaxStackSize(1);
    ...
    public ItemMeshDefinition getMeshDefinition() {
        return new CustomMeshDefinitionWillGem("InfSoulGem");
    }
    ...
    public void getSubItems(CreativeTabs creativeTab, NonNullList<ItemStack> list) {
        ...
        ItemStack emptyStack = new ItemStack(this, 1, 0);
        list.add(emptyStack);
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        EnumDemonWillType type = this.getCurrentType(stack);
        tooltip.add(TextHelper.localize("tooltip.bloodmagic.infSoulGem"));
