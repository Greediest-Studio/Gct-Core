package com.smd.gctcore.integration.mmce.adapter.te5;
...
public class CompactorPlateRecipeAdapter extends RecipeAdapter {

    private static final int ENERGY_PER_TICK = 20;

    public CompactorPlateRecipeAdapter() {
        super(new ResourceLocation("thermalexpansion", "compactor_plate"));
    }
    ...
    public Collection<MachineRecipe> createRecipesFor(ResourceLocation owningMachineName,
        ...
        for (CompactorRecipe recipeEntry : CompactorManager.getRecipeList(Mode.PLATE)) {
            ...
            MachineRecipe recipe = createRecipeShell(
                    new ResourceLocation("thermalexpansion", "compactor_plate_" + incId),
                    owningMachineName,
